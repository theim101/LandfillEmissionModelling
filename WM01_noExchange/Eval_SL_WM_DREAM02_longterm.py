...
import Initialize_WM_DREAM_LT as iWM
...
for ii in np.arange(len(par_set)):
    ...
    cumqDr, cDr, qDr, qInf, thCL, mCL, cInfCL, mbalerrCL, qrunoffCL, vW, mW = emOut
    ...
    totF_sim.append(cumqDr_tot[ii][iWM.tmeas_ind] - cumqDr_tot[ii][iWM.tmeas_ind[0]])
