...
import Initialize_KR3_DREAM01 as iKR
...
def likelihood(par):
    ...
    logp, emOut, lFPar, emLF = mymod.likelihood_Emission_Recirculate_LF (par,iKR.tdseries, 
                                iKR.lF, iKR.meteo_data, 
...
lower_limits = iKR.par_df.iloc[0].values
range_vals = iKR.par_df.iloc[1].values - iKR.par_df.iloc[0].values
