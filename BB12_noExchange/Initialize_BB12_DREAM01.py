...
pump_code = 'PP-12'
pklfile = './DataFiles/flowdata_PP-12.gz'
...
pklfile = './DataFiles/labdata_PP-12.gz'
...
trange = pd.date_range(start='2003-01-01',end = '2020-03-01',freq='D')
